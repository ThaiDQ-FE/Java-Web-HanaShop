...
public class UpdateNoImgServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ProductDTO dto = new ProductDTO(name, quantity, description, cate, price, status, date, "");
        try {
            HistoryDTO historyDTO = new HistoryDTO(fullname, action, date, id);
            ProductDAO dao = new ProductDAO();
            if(dao.updateNoImage(dto, id)){
